    ...
    <div class="row">
        <div class="col-md-3">
            <aside class="sidebar-left">
                <ul class="nav nav-pills nav-stacked nav-arrow" id="DataCompanyMenu">
                    <li class="active" data-link="#DataCompanyProfile"><a href="javascript:void(0);" class="skt-icon-ok-circled2"> Datos del Usuario</a></li>
                    <li data-link="#DataCompanyLocation"><a href="javascript:initMap();" class="skt-icon-location"> Mapa de Ubicación</a></li>
                    <!--<li data-link="#DataCompanyCategories"><a href="javascript:void(0);" class="skt-icon-tags"> Categorías</a></li>-->
                    <li data-link="#DataCompanyInterests"><a href="javascript:void(0);" class="skt-icon-lightbulb"> Intereses</a></li>
                    <?php if ($User->ClientAuth_id == NULL) { ?>
        ...
        <div class="col-md-9" id="DataForms">
            <div class="row row-wrap" id="DataCompanyProfile">
                ...
                <div class="col-md-3">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'EditAvatar.php');
                    ?>
                </div>
                <div class="col-md-9">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'EditData.php');
                    ?>
                </div>
                <div class="gap"></div>
            </div>
            <div class="row row-wrap" id="DataCompanyLocation" style="display: none;">
                <div class="col-md-12">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'EditLocation.php');
                    ?>
                </div>
                <div class="gap"></div>
            </div>
            ...
            <div class="row row-wrap" id="DataCompanyCategories" style="display: none;">
                <div class="col-md-12">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'EditCategories.php');
                    ?>
                </div>
                <div class="gap"></div>
            </div>
            ...
            <div class="row row-wrap" id="DataCompanyInterests" style="display: none;">
                <div class="col-md-12">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'EditInterests.php');
                    ?>
                </div> 
                <div class="gap"></div>
            </div>
            ...
            <div class="row row-wrap" id="DataUpdatePassword" style="display: none;">
                <div class="col-md-12">
                    <?php
                    require (dirname(dirname(__FILE__)) . DS . 'User' . DS . 'SetPassword.php');
                    ?>
                </div> 
                <div class="gap"></div>
            </div>
