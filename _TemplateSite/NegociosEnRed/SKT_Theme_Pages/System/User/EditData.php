...
<button type="button" onclick="UpdateData<?php echo $User->id ?>();" id="UpdateDataUser" class="right btn btn-primary btn-lg float-right" ><i class="skt-icon-ok-circled2"></i> Guardar Datos</button>
