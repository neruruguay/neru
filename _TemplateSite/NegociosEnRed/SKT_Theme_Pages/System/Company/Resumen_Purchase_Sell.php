...
$TemplateItem = \file_get_contents($DSTemplate . 'Resumen_Purchase_Sell.tpl');
?>
<h2>Mis Compras</h2>
<div class="row" id="TablePurchaseCompras">
...
<script type="text/javascript">
    ...
    function dataTableSell(){
        /*$('#TablePurchaseCompras .table').dataTable({
            "language": {
    ...
    function SemaphoreSell(OrderPurchase) {
