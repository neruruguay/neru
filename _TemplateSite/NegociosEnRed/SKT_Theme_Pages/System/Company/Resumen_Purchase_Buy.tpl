    ...
    <div class="ProductInfo col-md-11">
        ...
        <div class="row ProductBtns">
            ...
            <div class="text-right col-md-6 col-sm-12">
                <a class="popup-text btn btn-info ml10" href="#Order[OrderPurchase]-dialog" data-effect="mfp-zoom-out">Ver Datos del Comprador</a>
        ...
        <div class="row hidden">
            <div id="Order[OrderPurchase]-dialog" class="mfp-with-anim mfp-hide mfp-dialog clearfix">
                ...
                <div class="SellerInfo">
                    <b>[CustomerName]</b>
                    <span>RUT: [CustomerRUT]</span>
                    <span class="skt-icon-user">[CustomerName]</span>
                    <a href="mailto:[email]" class="skt-icon-icon-email">[CustomerEmail]</a>
                    <span class="skt-icon-mobile-1">[CustomerPhone]</span>
                </div> 
            </div>
            ...
            <div id="Order[OrderPurchase]-Confirm" class="mfp-with-anim mfp-hide mfp-dialog clearfix">
                ...
                <input type="hidden" value="Seller" name="Who"/>
                <input type="hidden" value="[OrderPurchase]" name="OrderPurchase"/>
                <input type="hidden" value="[Seller]" name="Whois"/>
                    <div class="form-group">
                        <label class="alert OrderPurchaseOk">Fue enviado correctamente <input type="radio" name="SendOrderPurchase" id="SendOrderPurchase_0" class="form-control" value="0"></label>
                        <label class="alert OrderPurchaseCancel">El pedido se cancela <input type="radio" name="SendOrderPurchase" id="SendOrderPurchase_1" class="form-control" value="1"></label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <b>Observaciones</b>
                        <textarea name="Opinion" class="form-control" placeholder="Cliente recomendable."></textarea>
                    </div>
                    <a  href="javascript:SemaphoreBuy('[OrderPurchase]');" class="btn btn-primary">Enviar</a>
