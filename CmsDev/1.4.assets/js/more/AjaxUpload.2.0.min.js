(function() {
    ...
    function I(O) {
        if (!O.pageX && O.clientX) {
            return{x: O.clientX + G.body.scrollLeft + G.documentElement.scrollLeft, y: O.clientY + G.body.scrollTop + G.documentElement.scrollTop}
        }
    ...
    (function() {
        ...
        Ajax_upload = AjaxUpload = function(R, P) {
            ...
            this._settings = {action: "upload.php", name: "userfile", data: {}, autoSubmit: true, onChange: function(S, T) {
        ...
        AjaxUpload.prototype = {setData: function(P) {
                ...
                var S = {position: "absolute", margin: "-5px 0 0 -175px", padding: 0, width: "220px", height: "10px", opacity: 0, cursor: "pointer", display: "none"};
                for (var R in S) {
                    P.style[R] = S[R]
                }
