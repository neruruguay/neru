    <div class="Producto galleriffic">
        <div class="Productslider">
          <div class="navigation-container">
            <div id="thumbs" class="navigation"> <a class="pageLink prev" style="visibility: hidden;" href="#" title="Previous Page"></a>
              <ul class="thumbs noscript">
              	<li>
                    <a class="thumb" name="optionalCustomIdentifier" href="_Thumb_/products/{ProductImage}/695x310">
                        <img src="_thumb_/products/{ProductImage}/100x50-c" alt="img" />
                    </a>
                </li>
		{ListFolder}
              </ul>
