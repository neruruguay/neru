...
/**
 * Description of EditorFiles
 * @tutorial 'Retrieve HTML parts from "_TemplateSite/[TEMPLATE]/SKT_Editor_Parts" and make list for HTML Editor.'
 *
 * @author Martin Daguerre
 */

namespace CmsDev\Layout;

class EditorLayoutsBox {
    ...
    function __construct() {
        // echo $FixLocalDir = str_replace(\SUBSITE,'',\LOCAL_DIR); 
        // echo \SKTURL_TemplateSite; exit();
        $HTML = '<div id="sktLayoutsObj">' . static::LayoutList(\SKTPATH_TemplateSite . 'SKT_Editor_Parts'.\DS, \SKTURL_TemplateSite . 'SKT_Editor_Parts'.\DS, 'tpl') . '</div>';
        \define('EditorLayoutsBox', \SKTPATH_TemplateSite . 'SKT_Editor_Parts'.\DS);
    }
