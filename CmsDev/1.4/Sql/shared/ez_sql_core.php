...
class ezSQLcore {
    ...
    function get_var($query = null, $x = 0, $y = 0) {
        ...
        $this->func_call = "\$SKTDB->get_var(\"$query\",$x,$y)";
    ...
    function get_row($query = null, $output = OBJECT, $y = 0) {
        ...
        $this->func_call = "\$SKTDB->get_row(\"$query\",$output,$y)";
        ...
        // If invalid output type was specified..
            ...
            $this->print_error(" \$SKTDB->get_row(string query, output type, int offset) -- Output type must be one of: OBJECT, ARRAY_A, ARRAY_N");
        }
    }
    ...
    function get_results($query = null, $output = OBJECT) {
        ...
        $this->func_call = "\$SKTDB->get_results(\"$query\", $output)";
     ...
     *     $SKTDB_data = array('login'=>'jv','email'=>'jv@vip.ie', 'user_id' => 1, 'created' => 'NOW()');

     *

     *     $SKTDB->query("INSERT INTO users SET ".$SKTDB->get_set($SKTDB_data));
     ...
     *     $SKTDB->query("UPDATE users SET ".$SKTDB->get_set($SKTDB_data)." WHERE user_id = 1");
