...
$Products = $SKTDB->get_results("SELECT * FROM Products as Product join Productprofile as profile WHERE Product.id = profile.idX ORDER BY Company ASC");
$Options = '';
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/Products/_Create';
                jQuery.ajax({
                    'type': 'POST',
