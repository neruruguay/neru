...
$query = $SKTDB->get_row("SELECT * FROM sections as Section join Sectionprofile as profile WHERE Section.id = " . \GetSQLValueString($id, "int") . " AND Section.id = profile.idX");
...
<div class="CreateContentHtml">
    <form action="" method="post" id="Form_sections">
        <input value="sections_Edit" name="sections_Edit" type="hidden"/>
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/sections/_Update';
                jQuery.ajax({
                    'type': 'POST',
