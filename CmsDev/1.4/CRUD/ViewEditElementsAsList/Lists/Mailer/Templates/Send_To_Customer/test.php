...
<div class="CreateContentHtml">
    <form action="" method="post" id="Form_Mailer" style="float: none;">
        <input name="Email_to" id="Email_to" type="text" class="form-control" value="<?php echo $data->Template_Customer_Email; ?>">
        <input name="Email_Subject" id="Email_Subject" type="text" class="form-control" value="Detalle de su compra">
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        //position: [0, 0],
        modal: true,
        title: 'Enviar mail al Comprador',
        buttons: {
            'Enviar': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/Mailer/Send_To_Customer';
                jQuery.ajax({
                    'type': 'POST',
