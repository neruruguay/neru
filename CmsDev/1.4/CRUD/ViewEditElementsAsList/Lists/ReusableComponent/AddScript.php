...
<div class="container_16">
    <div class="CreateContentHtml">
        <form action="" method="post" id="Form_ReusableComponent">
            ...
            <div class="grid_11">
                <textarea id="ReusableComponentEditor" name="ReusableComponentEditor"  style="width: 96%; height: 350px;">/*Script code sample*/
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        setTimeout('ReusableComponentScript()', 1000);
    });
