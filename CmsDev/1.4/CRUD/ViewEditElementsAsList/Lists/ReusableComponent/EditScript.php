...
<div class="container_16">
    <div class="CreateContentHtml">
        <form action="" method="post" id="Form_ReusableComponent">
            ...
            <div class="grid_11">
                <textarea id="ReusableComponentEditor" name="ReusableComponentEditor" style="width: 96%; height: 350px;"><?php echo \utf8_encode($query->Content); ?></textarea></div>
            <div class="grid_4">
                <?php
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        setTimeout('ReusableComponentScript()', 500);
    });

    function ReusableComponentScript() {
        var translations = [];
