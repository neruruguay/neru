...
$query = $SKTDB->get_row("SELECT * FROM users as user join userprofile as profile WHERE user.id = " . \GetSQLValueString($id, "int") . " AND user.id = profile.idX");
...
<div class="CreateContentHtml">
    <form action="" method="post" id="Form_Users">
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/Users/_Update';
                jQuery.ajax({
                    'type': 'POST',
