...
$users = $SKTDB->get_results("SELECT * FROM users as user join userprofile as profile WHERE user.id = profile.idX ORDER BY Company ASC");
$Options = '';
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/Users/_Create';
                jQuery.ajax({
                    'type': 'POST',
