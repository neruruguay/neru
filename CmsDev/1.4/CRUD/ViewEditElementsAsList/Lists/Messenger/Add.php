...
$Messenger = $SKTDB->get_results("SELECT * FROM messenger as message join userprofile as profile WHERE message.id = profile.idX ORDER BY Company ASC");
$Options = '';
foreach ($Messenger as $items) {
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/Messenger/_Create';
                jQuery.ajax({
                    'type': 'POST',
