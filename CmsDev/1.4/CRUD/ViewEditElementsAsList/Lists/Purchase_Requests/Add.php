...
$PurchaseRequestss = $SKTDB->get_results("SELECT * FROM PurchaseRequestss as PurchaseRequests join PurchaseRequestsprofile as profile WHERE PurchaseRequests.id = profile.idX ORDER BY Company ASC");
$Options = '';
foreach ($PurchaseRequestss as $items) {
...
<script type="text/javascript">
    ...
    $("#CmsDevDialogContent").dialog({
        ...
        buttons: {
            '[Save]': function () {
                var URLUPDATE = '/CRUD/ViewEditElementsAsList/Lists/PurchaseRequestss/_Create';
                jQuery.ajax({
                    'type': 'POST',
