...
<div class="row">
    ...
    echo $User_plan->RenderList();
    $SelfUser = $User_plan->Dataset('79');
    echo $SelfUser->Limit_Plan;
    ?>
</div>
...
<script type="text/javascript">
    ...
    $('.skt-btn-list-add').click(function () {
        var User_plan_Add = '/SKTGoTo/' + admd2('CRUD/ViewEditElementsAsList/Lists/User_plan/Add');
        jQuery.ajax({
            'type': 'POST',
            'url': User_plan_Add,
            'cache': false,
    ...
    $('.TableListElementsSKT .skt-icon-edit').click(function () {
        var User_plan_Edit = '/SKTGoTo/' + admd2('CRUD/ViewEditElementsAsList/Lists/User_plan/Edit');
        jQuery.ajax({
            'type': 'POST',
            'url': User_plan_Edit,
            'cache': false,
    ...
    $('.TableListElementsSKT .skt-icon-cancel').click(function () {
        ...
        $("#dialogConfirmDeleteItem").dialog({
            ...
            buttons: [{
                    ...
                    click: function () {
                        var User_plan_Delete = '/SKTGoTo/' + admd2('CRUD/ViewEditElementsAsList/Lists/User_plan/Delete');
                        $.ajax({
                            'type': 'POST',
                            'url': User_plan_Delete,
                            'cache': false,
