...
class UploadHandler {
    ...
    function __construct($suburl = '/files/', $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url() . '/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . $suburl,
            'upload_url' => $this->get_full_url() . $suburl,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
...
$upload_handler = new UploadHandler($_GET['Folder']);
